...
- **First-month retention:** 19-35% across cohorts (65-81% drop-off)
- **Stabilization:** ~20-30% by month 3
- **Best cohort:** Dec 2009 (954 customers) — 49.5% retention at month 11
...
5. **Fix first-month retention** — Post-purchase email sequence to address the 65-80% first-month drop-off
